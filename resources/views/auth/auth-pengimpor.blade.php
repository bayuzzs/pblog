										...
										<div class="mt-3">
												...
												<div id="register-tab" class="hidden" role="tabpanel" aria-labelledby="horizontal-alignment-item-2">
														<form class="space-y-3 md:space-y-4 lg:mt-5" action="{{ route('register.store') }}" method="POST">
																...
																<button type="submit"
																		class="me-2 w-full rounded-lg bg-blue-700 px-5 py-2.5 font-poppins text-sm text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300">Daftar</button>
														</form>
												</div>
										</div>
