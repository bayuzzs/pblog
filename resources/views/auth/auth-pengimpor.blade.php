								...
								<div id="auth-tab-content">
										...
										<div class="hidden px-4" id="login" role="tabpanel" aria-labelledby="profile-tab">
												<form class="space-y-3 md:space-y-4 lg:mt-5" action="{{ route('login.store') }}" method="POST">
														...
														<a href="{{ route('password.request') }}" class="mb-10 block text-sm text-gray-600">Lupa Password?
																klik <u>Disini</u></a>
														<button type="submit"
												...
												<form class="space-y-3 md:space-y-4 lg:mt-5" action="{{ route('register.store') }}" method="POST">
														...
														<div id="accordion-collapse" data-accordion="collapse">
																<h2 id="accordion-collapse-heading-1">
																		<button type="button"
																				class="flex w-full items-center justify-between gap-3 rounded-t-lg border border-gray-200 p-3 text-gray-500 hover:bg-gray-100 rtl:text-right"
														...
														<button type="submit"
																class="me-2 w-full rounded-lg bg-blue-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300">Daftar</button>
												</form>
										</div>
