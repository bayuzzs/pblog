		...
		<section class="bg-gray-50">
				<div class="mx-auto flex flex-col items-center justify-center px-6 py-8 md:h-screen lg:py-0">
						<a href="{{ route('home') }}" class="mb-6 flex flex-col items-center text-2xl font-semibold text-gray-900">
								<img class="max-w-72 mr-2" src="{{ asset('images/logo/polibatam-logistik.png') }}" alt="logo">
						</a>
						<div class="md: -0 w-full rounded-lg bg-white p-6 shadow sm:max-w-md sm:p-8">
								<div class="mb-4 border-b border-gray-200">
										<ul class="-mb-px flex flex-wrap justify-center text-center text-sm font-medium" id="default-tab"
								...
								<div id="auth-tab-content">
										...
										<div class="hidden rounded-lg" id="login" role="tabpanel" aria-labelledby="profile-tab">
												<form class="space-y-3 md:space-y-4 lg:mt-5" action="{{ route('login.store') }}" method="POST">
														...
														<a href="{{ route('password.request') }}" class="mt-2 text-sm text-green-600">Lupa Password?
																klik <u>Disini</u></a>
														<button type="submit"
																class="me-2 w-full rounded-lg bg-blue-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300">Login</button>
												</form>
										</div>
