				...
				<div class="mx-auto flex flex-col items-center justify-center px-6 py-8 md:h-screen lg:py-0">
						...
						<div class="w-full rounded-lg bg-white p-6 shadow sm:max-w-md sm:p-8 md:mt-0">
								...
								<form class="mt-4 space-y-4 md:space-y-5 lg:mt-5" action="{{ route('password.update') }}" method="POST">
										...
										<button type="submit"
												class="w-full rounded-lg bg-blue-600 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-blue-600 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-600 dark:focus:ring-blue-800">Atur
												Sandi</button>
								</form>
						</div>
				</div>
