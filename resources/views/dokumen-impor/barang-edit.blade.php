						...
						<div class="space-y-3 md:space-y-10">
								...
								<div class="grid grid-cols-3 items-center">
										...
										<div class="col-span-2">
												<x-select name="pernyataanLartas">
														<option value="1" {{ $barang->pernyataanLartas == 1 ? 'selected' : '' }}>YA</option>
														<option value="0" {{ $barang->pernyataanLartas == 0 ? 'selected' : '' }}>TIDAK</option>
												</x-select>
										</div>
								</div>
								<div class="grid grid-cols-3 items-center">
								...
								<div class="grid grid-cols-3 items-center">
										...
										<textarea name="uraian" required
										  ...
										  rows="3" placeholder="Uraian Barang">{{ $barang->uraian }}</textarea>
								</div>
								<div class="grid grid-cols-3 items-center">
										<label class="text-xs dark:text-gray-200 md:text-sm">Merk</label>
										<input type="text" name="merk" placeholder="Merk Barang" value="{{ $barang->merk }}" required
												class="col-span-2 block w-full rounded-lg border-gray-200 px-4 py-3 text-sm focus:border-blue-500 focus:ring-blue-500 disabled:pointer-events-none disabled:opacity-50 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-400 dark:placeholder-gray-500 dark:focus:ring-gray-600">
								</div>
								<div class="grid grid-cols-3 items-center">
										<label class="text-xs dark:text-gray-200 md:text-sm">Tipe</label>
										<input type="text" name="tipe" placeholder="Tipe Barang" value="{{ $barang->tipe }}" required
												class="col-span-2 block w-full rounded-lg border-gray-200 px-4 py-3 text-sm focus:border-blue-500 focus:ring-blue-500 disabled:pointer-events-none disabled:opacity-50 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-400 dark:placeholder-gray-500 dark:focus:ring-gray-600">
								</div>
								<div class="grid grid-cols-3 items-center">
										<label class="text-xs dark:text-gray-200 md:text-sm" for="ukuran">Ukuran</label>
										<input type="number" name="ukuran" id="ukuran" step="0.01" value="{{ $barang->ukuran }}"
												placeholder="Ukuran Barang" required
												class="col-span-2 block w-full rounded-lg border-gray-200 px-4 py-3 text-sm focus:border-blue-500 focus:ring-blue-500 disabled:pointer-events-none disabled:opacity-50 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-400 dark:placeholder-gray-500 dark:focus:ring-gray-600">
								</div>
								<div class="grid grid-cols-3 items-center">
										<label class="text-xs dark:text-gray-200 md:text-sm">Spesifikasi Lain</label>
										<input type="text" name="spesifikasiLain" id="spesifikasiLain" value="{{ $barang->spesifikasiLain }}"
												placeholder="Spesifikasi Lain Barang" required
												class="col-span-2 block w-full rounded-lg border-gray-200 px-4 py-3 text-sm focus:border-blue-500 focus:ring-blue-500 disabled:pointer-events-none disabled:opacity-50 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-400 dark:placeholder-gray-500 dark:focus:ring-gray-600">
								</div>
								<div class="grid grid-cols-3 items-center gap-2">
										...
										<div class="col-span-2">
												<x-select name="kondisiBarang">
														{!! generateKondisiBarangOptions($barang->kondisiBarang) !!}
												</x-select>
										</div>
								</div>
								<div class="grid grid-cols-3 items-center">
										...
										<div class="col-span-2">
												<x-combobox name="kodeNegara" fieldName="kodeNegara" apiUrl="{{ route('api.negara') }}"
														value="{{ $barang->kodeNegara }}" searchName="namaNegara" placeholder="Cari Negara">
												</x-combobox>
										</div>
								</div>
								<div class="grid grid-cols-3 items-center gap-2">
										<label class="text-xs dark:text-gray-200 md:text-sm" for="beratBersih">Berat Bersih (Kg)</label>
										<input type="number" name="beratBersih" id="beratBersih" step="0.0001" value="{{ $barang->beratBersih }}"
						...
						<div class="space-y-3 md:space-y-10">
								<div class="grid grid-cols-3 items-center">
										...
										<div class="col-span-2 grid grid-cols-4 gap-2">
												<input type="number" name="nilaiSatuan" id="nilaiSatuan" value="{{ $barang->nilaiSatuan }}"
														placeholder="000"
												...
												<div class="col-span-3">
														<x-combobox name="kodeSatuanBarang" apiUrl="{{ route('api.satuan-barang') }}"
																value="{{ $barang->kodeSatuanBarang }}" fieldName="kodeSatuanBarang" searchName="namaSatuanBarang"
								...
								<div class="grid grid-cols-3 items-center">
										...
										<div class="col-span-2 grid grid-cols-4 gap-2">
												<input type="number" name="nilaiKemasan" id="nilaiKemasan" value="{{ $barang->nilaiKemasan }}"
														placeholder="000"
														class="col-span-1 block w-full rounded-lg border-gray-200 px-4 py-3 text-sm focus:border-blue-500 focus:ring-blue-500 disabled:pointer-events-none disabled:opacity-50 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-400 dark:placeholder-gray-500 dark:focus:ring-gray-600">
												<div class="col-span-3">
														<x-combobox name="kodeJenisKemasan" apiUrl="{{ route('api.jenis-kemasan') }}"
																value="{{ $barang->kodeJenisKemasan }}" fieldName="kodeJenisKemasan" searchName="namaKemasan"
								...
								<div class="grid grid-cols-3 items-center">
										...
										<input type="number" name="amountDAT" id="amountDAT" step="0.01" value="{{ $barang->amountDAT }}"
												placeholder="Masukan nilai DAT" required
												class="col-span-2 block w-full rounded-lg border-gray-200 px-4 py-3 text-sm focus:border-blue-500 focus:ring-blue-500 disabled:pointer-events-none disabled:opacity-50 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-400 dark:placeholder-gray-500 dark:focus:ring-gray-600">
								</div>
								<div class="grid grid-cols-3 items-center gap-2">
										...
										<div class="col-span-2">
												<x-select name="jenisNilai">
														{!! generateJenisNilaiOptions($barang->jenisNilai) !!}
												</x-select>
										</div>
								</div>
								<div class="grid grid-cols-3 items-center">
										<label class="text-xs dark:text-gray-200 md:text-sm">Jatuh Tempo</label>
										<input type="date" name="jatuhTempo" id="jatuhTempo" value="{{ $barang->jatuhTempo }}" required
												class="col-span-2 block w-full rounded-lg border-gray-200 px-4 py-3 text-sm focus:border-blue-500 focus:ring-blue-500 disabled:pointer-events-none disabled:opacity-50 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-400 dark:placeholder-gray-500 dark:focus:ring-gray-600">
								</div>
								<div class="grid grid-cols-3 items-center">
										...
										<input type="number" name="voluntaryDeclaration" id="voluntaryDeclaration" step="0.01"
												placeholder="Masukkan nilai" value="{{ $barang->voluntaryDeclaration }}" required
												class="col-span-2 block w-full rounded-lg border-gray-200 px-4 py-3 text-sm focus:border-blue-500 focus:ring-blue-500 disabled:pointer-events-none disabled:opacity-50 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-400 dark:placeholder-gray-500 dark:focus:ring-gray-600">
								</div>
								<div class="grid grid-cols-3 items-center">
										<label class="text-xs dark:text-gray-200 md:text-sm">(Biaya Tambahan - Diskon)</label>
										<input type="number" name="biayaTambahanDiskon" id="biayaTambahanDiskon" step="0.01"
												value="{{ $barang->biayaTambahanDiskon }}" placeholder="0.00" required
												class="col-span-2 block w-full rounded-lg border-gray-200 px-4 py-3 text-sm focus:border-blue-500 focus:ring-blue-500 disabled:pointer-events-none disabled:opacity-50 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-400 dark:placeholder-gray-500 dark:focus:ring-gray-600">
								</div>
								<div class="grid grid-cols-3 items-center">
										<label class="text-xs dark:text-gray-200 md:text-sm">FOB</label>
										<input type="number" name="fob" id="fob" step="0.01" value="{{ $barang->fob }}"
												placeholder="0.00" required
												class="col-span-2 block w-full rounded-lg border-gray-200 px-4 py-3 text-sm focus:border-blue-500 focus:ring-blue-500 disabled:pointer-events-none disabled:opacity-50 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-400 dark:placeholder-gray-500 dark:focus:ring-gray-600">
								</div>
								<div class="grid grid-cols-3 items-center">
										<label class="text-xs dark:text-gray-200 md:text-sm">Harga Satuan</label>
										<input type="number" name="hargaSatuan" id="hargaSatuan" value="{{ $barang->hargaSatuan }}"
												step="0.01" placeholder="0.00" required
												class="col-span-2 block w-full rounded-lg border-gray-200 px-4 py-3 text-sm focus:border-blue-500 focus:ring-blue-500 disabled:pointer-events-none disabled:opacity-50 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-400 dark:placeholder-gray-500 dark:focus:ring-gray-600">
								</div>
								<div class="grid grid-cols-3 items-center">
										<label class="text-xs dark:text-gray-200 md:text-sm">Freight</label>
										<input type="number" name="freight" id="freight" step="0.01" value="{{ $barang->freight }}"
												placeholder="0.00" required
												class="col-span-2 block w-full rounded-lg border-gray-200 px-4 py-3 text-sm focus:border-blue-500 focus:ring-blue-500 disabled:pointer-events-none disabled:opacity-50 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-400 dark:placeholder-gray-500 dark:focus:ring-gray-600">
								</div>
								<div class="grid grid-cols-3 items-center">
										<label class="text-xs dark:text-gray-200 md:text-sm">Asuransi</label>
										<input type="number" name="asuransi" id="asuransi" step="0.0001" value="{{ $barang->asuransi }}"
												placeholder="0.0000" required
												class="col-span-2 block w-full rounded-lg border-gray-200 px-4 py-3 text-sm focus:border-blue-500 focus:ring-blue-500 disabled:pointer-events-none disabled:opacity-50 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-400 dark:placeholder-gray-500 dark:focus:ring-gray-600">
								</div>
								<div class="grid grid-cols-3 items-center">
										<label class="text-xs dark:text-gray-200 md:text-sm">CIF Rupiah</label>
										<input type="number" name="cif" id="cif" step="0.01" value="{{ $barang->cif }}"
												placeholder="0.00" required
												class="col-span-2 block w-full rounded-lg border-gray-200 px-4 py-3 text-sm focus:border-blue-500 focus:ring-blue-500 disabled:pointer-events-none disabled:opacity-50 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-400 dark:placeholder-gray-500 dark:focus:ring-gray-600">
								</div>
						</div>
