<div id="application-sidebar"
		...
		<nav class="hs-accordion-group flex w-full flex-col flex-wrap p-6" data-hs-accordion-always-open>
				<ul class="space-y-1.5">
						<li>
								<a class="{{ request()->routeIs('dashboard') ? 'bg-gray-100 dark:bg-gray-700' : '' }} flex items-center gap-x-3.5 rounded-lg px-2.5 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-white"
										href="#">
