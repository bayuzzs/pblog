						...
						<div class="flex items-center justify-between">
								<div class="flex items-center justify-start rtl:justify-end">
										...
										<a href="{{ route('home') }}" class="ms-2 flex md:me-24">
												<img src="{{ asset('images/logo/polibatam-logistik-caption.png') }}" class="me-3 h-8"
														alt="Polibatam Logistik Logo" />
										</a>
								</div>
								<div class="flex items-center">
										<div class="ms-3 flex items-center">
												<div>
														<button type="button" class="flex rounded-full bg-gray-800 text-sm focus:ring-4 focus:ring-blue-300"
												...
												<div class="min-w-40 z-50 my-4 hidden list-none divide-y divide-gray-100 rounded bg-white text-base shadow"
														id="dropdown-user">
														...
														<ul class="py-1" role="none">
																...
																<li>
																		...
																		{{-- <form action="{{ route('logout') }}" method="post" class="block bg-red-300">
																				@csrf
						...
						<ul class="space-y-2 font-medium">
								<li>
										<a href="#" class="group flex items-center rounded-lg p-2 text-gray-900 hover:bg-gray-100">
												<svg class="h-5 w-5 text-gray-500 transition duration-75 group-hover:text-gray-900" aria-hidden="true"
